...
class Mails:
    ...
    def sendEmailBalance(self, mensaje,email_date, contador_loan, contador_ayer, flag_duplicados):
        ...
        try:
            ...
            subject = "Control de balances del dia: " + str(email_date.strftime("%d/%m/%Y"))
            ...
            logging.error("Error sendEmailBalance - %s." % str(exception))