...
class Mails:
    ...
    def sendEmailFlowsStepsStatus_html(self, mensaje, email_date):
        try:
            port = 465  # Para SSL
            ...
            subject = "Control de status of flows del dia: " + str(email_date.strftime("%d/%m/%Y")) + " a las " + str(
...
# Uso del método
#mail_instance = Mails()
#mail_instance.sendEmailFlowsStepsStatus("<p>Este es un mensaje HTML de ejemplo</p>", email_date)