...
class Mails:
    ...
    def sendEmailAccrual(self, mensaje,email_date, contador_loan, contador_ayer, flag_duplicados):
        ...
        try:
            ...
            subject = "Control de Accruals del dia: " + str(email_date.strftime("%d/%m/%Y"))
            ...
            logging.error("Error sendEmailAccrual - %s." % str(exception))